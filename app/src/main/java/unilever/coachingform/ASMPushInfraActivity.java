...
public class ASMPushInfraActivity extends AppCompatActivity {
    Context context;
    Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radio_1_a = (RadioButton) findViewById(R.id.asm_push_infra_1_a);
        radio_1_b = (RadioButton) findViewById(R.id.asm_push_infra_1_b);
        radio_1_c = (RadioButton) findViewById(R.id.asm_push_infra_1_c);
        radio_1_d = (RadioButton) findViewById(R.id.asm_push_infra_1_d);
        radio_1_e = (RadioButton) findViewById(R.id.asm_push_infra_1_e);
        radio_1_f = (RadioButton) findViewById(R.id.asm_push_infra_1_f);
        radio_1_g = (RadioButton) findViewById(R.id.asm_push_infra_1_g);
        radio_2_a = (RadioButton) findViewById(R.id.asm_push_infra_2_a);
        radio_2_b = (RadioButton) findViewById(R.id.asm_push_infra_2_b);
        radio_2_c = (RadioButton) findViewById(R.id.asm_push_infra_2_c);
        radio_2_d = (RadioButton) findViewById(R.id.asm_push_infra_2_d);
        radio_2_e = (RadioButton) findViewById(R.id.asm_push_infra_2_e);
        radio_3 = (RadioButton) findViewById(R.id.asm_push_infra_3);
    ...
    private void saveQA() {
        addingQA("","asm_push_infra_1_a",status_1_a,remarks_1_a.getText().toString(),true);
        addingQA("","asm_push_infra_1_b",status_1_b,remarks_1_b.getText().toString(),true);
        addingQA("","asm_push_infra_1_c",status_1_c,remarks_1_c.getText().toString(),true);
        addingQA("","asm_push_infra_1_d",status_1_d,remarks_1_d.getText().toString(),true);
        addingQA("","asm_push_infra_1_e",status_1_e,remarks_1_e.getText().toString(),true);
        addingQA("","asm_push_infra_1_f",status_1_f,remarks_1_f.getText().toString(),true);
        addingQA("","asm_push_infra_1_g",status_1_g,remarks_1_g.getText().toString(),true);
        addingQA("","asm_push_infra_2_a",status_2_a,remarks_2_a.getText().toString(),true);
        addingQA("","asm_push_infra_2_b",status_2_b,remarks_2_b.getText().toString(),true);
        addingQA("","asm_push_infra_2_c",status_2_c,remarks_2_c.getText().toString(),true);
        addingQA("","asm_push_infra_2_d",status_2_d,remarks_2_d.getText().toString(),true);
        addingQA("","asm_push_infra_2_e",status_2_e,remarks_2_e.getText().toString(),true);
        addingQA("","asm_push_infra_3",status_3,remarks_3.getText().toString(),true);
        CoachingQuestionAnswerDAO.insertCoachingQA(coachingQAs, new CoachingQuestionAnswerDAO.InsertCoachingQAListener() {
            ...
            public void onInsertQuestionAnswerCompleted(boolean isSuccess) {
                if (isSuccess) {
                    Intent intent = new Intent(ASMPushInfraActivity.this, ASMPushMarketActivity.class);
                    ...
                    Toast.makeText(ASMPushInfraActivity.this, "Failed to save the data!!!",
    ...
    View.OnClickListener onClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(v.getId() == R.id.next) {
                ...
                Intent intent = new Intent(ASMPushInfraActivity.this, ASMPushSebelumActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                Intent intent = new Intent(ASMPushInfraActivity.this, ASMPushReportActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                intent.putExtra("id", coachingSessionID);
                startActivity(intent);
            } else if (v.getId() == R.id.asm_push_infra_1_a) {
                if(status_1_a) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_1_b) {
                if(status_1_b) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_1_c) {
                if(status_1_c) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_1_d) {
                if(status_1_d) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_1_e) {
                if(status_1_e) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_1_f) {
                if(status_1_f) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_1_g) {
                if(status_1_g) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_2_a) {
                if(status_2_a) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_2_b) {
                if(status_2_b) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_2_c) {
                if(status_2_c) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_2_d) {
                if(status_2_d) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_2_e) {
                if(status_2_e) {
            ...
            } else if (v.getId() == R.id.asm_push_infra_3) {
                if(status_3) {
