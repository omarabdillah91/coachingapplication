...
public class ASMPushReportActivity extends AppCompatActivity {
    Context context;
    Button next;
    ...
    RadioButton radio_1_a, radio_1_b, radio_2_a, radio_2_b, radio_3_a, radio_3_b, radio_3_c, radio_3_d;
    EditText remarks_1_a, remarks_1_b, remarks_2_a, remarks_2_b, remarks_3_a, remarks_3_b, remarks_3_c, remarks_3_d;
    boolean status_1_a, status_1_b, status_2_a, status_2_b, status_3_a, status_3_b, status_3_c, status_3_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radio_1_a = (RadioButton) findViewById(R.id.asm_push_report_1_a);
        radio_1_b = (RadioButton) findViewById(R.id.asm_push_report_1_b);
        radio_2_a = (RadioButton) findViewById(R.id.asm_push_report_2_a);
        radio_2_b = (RadioButton) findViewById(R.id.asm_push_report_2_b);
        radio_3_a = (RadioButton) findViewById(R.id.asm_push_report_3_a);
        radio_3_b = (RadioButton) findViewById(R.id.asm_push_report_3_b);
        radio_3_c = (RadioButton) findViewById(R.id.asm_push_report_3_c);
        radio_3_d = (RadioButton) findViewById(R.id.asm_push_report_3_d);
        ...
        remarks_3_d = (EditText) findViewById(R.id.remarks_report_3_d);
        ...
        radio_3_d.setOnClickListener(onClick);
    }
    ...
    private void saveQA() {
        addingQA("","asm_push_report_1_a",status_1_a,remarks_1_a.getText().toString(),true);
        addingQA("","asm_push_report_1_b",status_1_b,remarks_1_b.getText().toString(),true);
        addingQA("","asm_push_report_2_a",status_2_a,remarks_2_a.getText().toString(),true);
        addingQA("","asm_push_report_2_b",status_2_b,remarks_2_b.getText().toString(),true);
        addingQA("","asm_push_report_3_a",status_3_a,remarks_3_a.getText().toString(),true);
        addingQA("","asm_push_report_3_b",status_3_b,remarks_3_b.getText().toString(),true);
        addingQA("","asm_push_report_3_c",status_3_c,remarks_3_c.getText().toString(),true);
        addingQA("","asm_push_report_3_d",status_3_d,remarks_3_d.getText().toString(),true);
        CoachingQuestionAnswerDAO.insertCoachingQA(coachingQAs, new CoachingQuestionAnswerDAO.InsertCoachingQAListener() {
            ...
            public void onInsertQuestionAnswerCompleted(boolean isSuccess) {
                if (isSuccess) {
                    Intent intent = new Intent(ASMPushReportActivity.this, ASMPushInfraActivity.class);
                    ...
                    Toast.makeText(ASMPushReportActivity.this, "Failed to save the data!!!",
    ...
    View.OnClickListener onClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(v.getId() == R.id.next) {
                ...
                Intent intent = new Intent(ASMPushReportActivity.this, ASMPushSebelumActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                Intent intent = new Intent(ASMPushReportActivity.this, ASMPushMarketActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                intent.putExtra("id", coachingSessionID);
                startActivity(intent);
            } else if (v.getId() == R.id.asm_push_report_1_a) {
                if(status_1_a) {
            ...
            } else if (v.getId() == R.id.asm_push_report_1_b) {
                if(status_1_b) {
            ...
            } else if (v.getId() == R.id.asm_push_report_2_a) {
                if(status_2_a) {
            ...
            } else if (v.getId() == R.id.asm_push_report_2_b) {
                if(status_2_b) {
            ...
            } else if (v.getId() == R.id.asm_push_report_3_a) {
                if(status_3_a) {
            ...
            } else if (v.getId() == R.id.asm_push_report_3_b) {
                if(status_3_b) {
            ...
            } else if (v.getId() == R.id.asm_push_report_3_c) {
                if(status_3_c) {
            ...
            } else if (v.getId() == R.id.asm_push_report_3_d) {
                if(status_3_d) {
                    radio_3_d.setChecked(false);
                    status_3_d = false;
                } else {
                    status_3_d = true;
                    radio_3_d.setChecked(true);
                }
            }
        }
    };
