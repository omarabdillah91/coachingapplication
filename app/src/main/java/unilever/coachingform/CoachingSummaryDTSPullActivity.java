...
public class CoachingSummaryDTSPullActivity extends AppCompatActivity {
    private static final String TAG = "SummaryDTSPullctivity";
    Button next;
    ...
    private void saveQA() {
        ...
        addingQA("","dts_pul_summary_2",false,summary_2.getText().toString(),false);
        addingQA("","dts_pul_summary_3",false, summary_3.getText().toString(), false);
        CoachingSessionDAO.updateAction(coachingSessionID, summary_3.getText().toString(),
                new CoachingSessionDAO.UpdateCoachingListener() {
                    @Override
                    public void onGuidelineUpdated(boolean isSuccess) {
