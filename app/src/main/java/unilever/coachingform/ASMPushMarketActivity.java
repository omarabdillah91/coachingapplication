...
public class ASMPushMarketActivity extends AppCompatActivity {
    ...
    EditText remarks_1, remarks_2, remarks_3, remarks_4, remarks_5;
    boolean status_1, status_2, status_3, status_4, status_5;
    @Override
    ...
    private void saveQA() {
        addingQA("","asm_push_market_1",status_1,remarks_1.getText().toString(),true);
        addingQA("","asm_push_market_2",status_2,remarks_2.getText().toString(),true);
        addingQA("","asm_push_market_3",status_3,remarks_3.getText().toString(),true);
        addingQA("","asm_push_market_4",status_4,remarks_4.getText().toString(),true);
        addingQA("","asm_push_market_5",status_5,remarks_5.getText().toString(),true);
        CoachingQuestionAnswerDAO.insertCoachingQA(coachingQAs, new CoachingQuestionAnswerDAO.InsertCoachingQAListener() {
            ...
            public void onInsertQuestionAnswerCompleted(boolean isSuccess) {
                if (isSuccess) {
                    Intent intent = new Intent(ASMPushMarketActivity.this, CoachingSummaryASMPushActivity.class);
                    ...
                    Toast.makeText(ASMPushMarketActivity.this, "Failed to save the data!!!",
    ...
    View.OnClickListener onClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(v.getId() == R.id.next) {
                ...
                Intent intent = new Intent(ASMPushMarketActivity.this, ASMPushSebelumActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                Intent intent = new Intent(ASMPushMarketActivity.this, ASMPushReportActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                Intent intent = new Intent(ASMPushMarketActivity.this, ASMPushInfraActivity.class);
                intent.putExtra("coach", coach.getText().toString());
                intent.putExtra("job", job);
                intent.putExtra("coachee", coachee.getText().toString());
                intent.putExtra("bahasa",bahasa);
                ...
                intent.putExtra("id", coachingSessionID);
                startActivity(intent);
            } else if (v.getId() == R.id.asm_push_pasar_1) {
                if(status_1) {
            ...
            } else if (v.getId() == R.id.asm_push_pasar_2) {
                if(status_2) {
            ...
            } else if (v.getId() == R.id.asm_push_pasar_3) {
                if(status_3) {
            ...
            } else if (v.getId() == R.id.asm_push_pasar_4) {
                if(status_4) {
            ...
            } else if (v.getId() == R.id.asm_push_pasar_5) {
                if(status_5) {
