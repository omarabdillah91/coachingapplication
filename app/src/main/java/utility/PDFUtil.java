...
public class PDFUtil {
    ...
    public static void createSRPULLPDF(CoachingSessionEntity coachingSession,
                                        Map<Pair<String, String>, CoachingQuestionAnswerEntity> qaMap,
                                        GeneratePDFListener listener) {
        ...
        try {
            ...
            tableReport.addCell(createNormalCell(getString("sr_pull_report_how_1", lang)));
            tableReport.addCell("");
            tableReport.addCell("");


            String[] reportID = {"1","1_a","1_b","1_c","1_d","1_e","2"};

            for(String id: reportID){
                String temp = "sr_pull_report_1_" + id;
                tableReport.addCell(createNormalCell(getString(temp, lang)));
                String questionID = "sr_pull_report_1_" + id;
                String columnID = "";
            ...
            tableReport.addCell(createNormalCell(getString("sr_pull_report_title_2", lang)));
            tableReport.addCell("");
            tableReport.addCell("");

            tableReport.addCell(createNormalCell(getString("sr_pull_report_how_2", lang)));
            tableReport.addCell("");
            tableReport.addCell("");

            for (int i = 1; i <= 18; i++) {
                String temp = "sr_pull_report_2_" + i;
                tableReport.addCell(createNormalCell(getString(temp, lang)));
                ...
                for (int j = 1; j <= 2; j++) {
                    String questionID = "sr_pull_report_2_" + i + "_" + index[j];
                    String columnID = "";
            ...
            for (String id : srSaat) {
                String temp = "sr_pull_saat_" + id;
                tableHabbit.addCell(createNormalCell(getString(temp, lang)));
                String questionID = "sr_pull_kunjungan_" + id;
                String columnID = "";
